...
package me.sytex.knockback.impl.v1_21;
...
public class VersionHandler1_21 implements VersionHandler {

  @Override
  public AttributeInstance getAttributeInstance(@NotNull LivingEntity entity) {
    return entity.getAttribute(Attribute.GENERIC_EXPLOSION_KNOCKBACK_RESISTANCE);
  }
}
